...
public class SolutionRegularFlight implements Flight {
    ...
    private SolutionRegularFlight(String flightId, Airport from, Airport to, int totalCapacity) {
    ...
    public static SolutionRegularFlight of(String flightId, Airport from, Airport to, int totalCapacity) {
        ...
        return new SolutionRegularFlight(flightId, from, to, totalCapacity);
    }
    ...
    public boolean equals(Object o) {
        ...
        SolutionRegularFlight flight = (SolutionRegularFlight) o;
